...
const Login = ({ setNickname, userData, setUserInfo }) => {
    ...
    return (
        <Fragment>
            <div className='wrap'>
                <LoginForm>
                    <LoginBox>
                    <LoginIp type="text" id='ID' value={inputId} onChange={handleInputId} />
                    <LoginLabel for="ID">아이디</LoginLabel>
                    </LoginBox>
                    {/* password 적는 input*/}
                    <LoginBox>
                    <LoginIp type="password" id='PASSWORD' value={inputPw} onChange={handleInputPw} />
